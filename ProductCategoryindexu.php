<html lang="en">
<head>
	<title>PPP Product Category Update</title>
...
<body>
    ...
    <div class="center">
		<center>
			<br>
            <b><h1 style="font-size: 50px;">Product Category Schema Update</h1></b>
            <br><br><br><br>
			<form action="ProductCategoryupdate.php" method="post">
			
			<b><div id="select">
			<select name='Column' style="background-color: rgb(78, 80, 77);color: rgb(146,208,80);height: 7%;width: 10%;">
				<option value="PCatID">PCatID</option>
