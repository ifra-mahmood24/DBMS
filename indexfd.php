...
<body>
    ...
    <div class="center">
        <center>
            <br>
            <b><h1 style="font-size: 50px;">Product Information Schema Delete</h1></b>
            <br><br><br><br>
            <form action="deletef.php" method="post">
                
                <b><p>
                <label for="ProductID" style="font-size: 40px;">Product ID:</label>
                <input type="text" name="ProductID" id="ProductID" style="margin-left: 13%;background-color: rgb(78, 80, 77);color:rgb(146,208,80);height: 5%;">
                </p>
...
<p>
                ...
                <input type="text" name="BarCode" id="BarCode" style="margin-left: 16%;background-color: rgb(78, 80, 77);color:rgb(146,208,80);height: 5%;">
                </p>

<p>
                <label for="ColorID" style="font-size: 40px;">Color ID:</label>
                <input type="text" name="ColorID" id="ColorID" style="margin-left: 17%;background-color: rgb(78, 80, 77);color:rgb(146,208,80);height: 5%;">
                </p>
